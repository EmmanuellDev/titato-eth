        ...
        <>
          <header className="relative z-10 py-6 px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center">
              <div className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-lime-500">
                XO-Tactics
              </div>
          ...
          <main className="relative z-10 flex flex-col items-center flex-grow px-4 py-8">
            {!gameStarted ? (
              ...
              <div className="text-center w-full max-w-md mx-auto">
                <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-lime-600">
                  EASY MODE
                </h2>
                ...
                <div className="mt-6 space-x-4">
                  <button
                    onClick={resetGame}
                    className="px-6 py-2 rounded-full bg-gradient-to-r from-green-400 to-lime-600 text-white font-semibold hover:shadow-lg transition-all duration-300"
                  >
                    Reset Game
                  </button>
                  <button

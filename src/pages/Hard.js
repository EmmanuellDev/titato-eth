      ...
      {!currentAccount ? (
        <div className="relative z-10 flex flex-col items-center justify-center flex-grow px-4">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-6xl orbitron font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-orange-600">
              Unauthorized
            </h1>
            ...
            <button
              onClick={() => navigate('/')}
              className="px-6 py-3 rounded-full bg-gradient-to-r from-red-500 to-orange-600 text-white font-semibold hover:from-red-400 hover:to-orange-500 transition-all duration-300"
            >
              Back to Home
            </button>
          </div>
            ...
            {!gameStarted ? (
              ...
              <div className="text-center w-full max-w-md mx-auto">
                ...
                <div className="mt-6 space-x-4">
                  <button
                    onClick={resetGame}
                    className="px-6 py-2 rounded-full bg-gradient-to-r from-red-500 to-orange-600 text-white font-semibold hover:shadow-lg transition-all duration-300"
                  >
                    Reset Game
                  </button>
                  <button
